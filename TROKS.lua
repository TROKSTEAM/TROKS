...
SUDO = SUDO
sudo_users = {SUDO,716078713,716078713}   
print([[
 _______ _____   ____  _  __ _____ 
|__   __|  __ \ / __ \| |/ // ____|
   | |  | |__) | |  | | ' /| (___  
   | |  |  _  /| |  | |  <  \___ \ 
   | |  | | \ \| |__| | . \ ____) |
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TROKSTEAM/FIlES_TROKS/main/File_Bot/commands.lua") 
t = "\27[35m".."\nAll Files Started : \n-----------------------------------\n"..'\27[m'
i = 0
...
if hash or SudoBot(msg) or DevTROKSW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTROKSW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTROKSW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTROKSW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTROKSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTROKSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTROKSW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(716078713) then  
var = true  
elseif tonumber(user_id) == tonumber(716078713) then
var = true  
...
local UserName = (data.username_ or "TROKS")
...
local TROKS_Msg = ''  
if msgs < 100 then 
TROKS_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
TROKS_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
TROKS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
TROKS_Msg = 'متفاعل' 
elseif msgs < 1200 then 
TROKS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
TROKS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
TROKS_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
TROKS_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
TROKS_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TROKS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TROKS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TROKS_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
TROKS_Msg = 'رب التفاعل'  
end 
return TROKS_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@Sjr_20")  
...
--------------------------------------------------------------------------------------------------------------
function SourceTROKS(msg,data) -- بداية العمل   
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'تروكس')
SourceTROKSr = '※︙مرحبا بك عزيزي 👋🏼،\n※︙انا بوت حمايه المجموعات  ؟\n※︙يمكنك اضافتي الى مجموعتك •\n※︙آضفني وارفعني مشرف ارسل < تفعيل >\n[ᴄʜ › ᴛʀᴏᴋs ᴛᴇᴀᴍ ⁦˖](T.ME/uu12uu)'
end
send(msg.chat_id_, msg.id_, SourceTROKSr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevTROKSW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTROKSW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,TROKS_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ※' and DevTROKSW(msg) then  
...
if text == 'تعطيل التواصل ※' and DevTROKSW(msg) then  
...
if text == 'تفعيل البوت الخدمي ※' and DevTROKSW(msg) then  
...
if text == 'تعطيل البوت الخدمي ※' and DevTROKSW(msg) then  
...
if text == 'ضع كليشه ستارت ※' and DevTROKSW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *※︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ※' and DevTROKSW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *※︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ※' and DevTROKSW(msg) then 
...
if text == 'تحديث السورس ※' and DevTROKSW(msg) then 
os.execute('rm -rf TROKS.lua')
os.execute('wget https://raw.githubusercontent.com/TROKSTEAM/TROKS/main/TROKS.lua')
send(msg.chat_id_, msg.id_,' *※︙تم تحديث السورس* \n*※︙لديك اخر اصدار لسورس تروكس*\n*※︙الاصدار » { 2.9v}*')
dofile('TROKS.lua')  
end
if text == 'الاصدار ※' and DevTROKSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *※︙اصدار سورس تروكس* \n*※︙الاصدار »{ 2.9v}*')
end
if text == 'قناه تحديثات البوت ※' and DevTROKSW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ※︙[تحديثات البوت](T.ME/uu12uu) \n※︙[قناه السورس](T.ME/uu12uu)')
end
if text == "ضع اسم للبوت ※" and DevTROKSW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *※︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ※' and DevTROKSW(msg) then 
...
if text == 'المشتركين ※' and DevTROKSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *※︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ※' and DevTROKSW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *※︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ※") and DevTROKSW(msg) then
...
if text == ("قائمه العام ※") and DevTROKSW(msg) then
...
if text == ("قائمه الكتم العام ※") and DevTROKSW(msg) then
...
if text=="اذاعه خاص ※" and msg.reply_to_message_id_ == 0 and DevTROKSW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل الان اذاعتك؟* \n*※︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ※" and msg.reply_to_message_id_ == 0 and DevTROKSW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل الان اذاعتك؟* \n*※︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ※" and msg.reply_to_message_id_ == 0 and DevTROKSW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل الان اذاعتك؟* \n*※︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ※" and msg.reply_to_message_id_ == 0  and DevTROKSW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ※" and msg.reply_to_message_id_ == 0  and DevTROKSW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ※︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ※' and DevTROKSW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ※" and DevTROKSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ※" and DevTROKSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*※︙عدد الكروبات الان » { '..#group..' }'..TROKSk..''..TROKS..'*\n*※︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTROKSW(msg) then
...
usertext = '*\n ※︙العضو »* ['..result.title_..'](t.me/'..(username or 'TROKS')..')'
status  = '\n *※︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevTROKSW(msg) then
...
usertext = '\n *※︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TROKS')..')'
status  = '\n*※︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTROKSW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTROKSW(msg) then
...
local TROKS1_Msg = database:get(bot_id.."TROKS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TROKS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *※︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TROKS')..') \n ※︙'..TROKS1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if TROKS_Msg and not Special(msg) then  
local TROKS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TROKS_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *※︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n※︙["..TROKS_Msg.."] \n")
else
send(msg.chat_id_,0," *※︙العضو :* {["..data.first_name_.."](T.ME/uu12uu)}\n※︙["..TROKS_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *※︙عذرا »* {["..data.first_name_.."](T.ME/uu12uu)}\n*※︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTROKSW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTROKSW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTROKSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *※︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTROKSW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *※︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ※" and DevTROKSW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *※︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ※$") and DevTROKSW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *※︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ※" and DevTROKSW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ※" and DevTROKSW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *※︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ※" and DevTROKSW(msg) then  
...
database:sadd(bot_id.."oska:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."oska:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_oska = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_oska then 
names_oska = database:smembers(bot_id.."oska:blocname"..msg.chat_id_) or ""
if names_oska and names_oska[1] then 
for i=1,#names_oska do 
if name_oska:match("(.*)("..names_oska[i]..")(.*)") then 
...
database:set(bot_id.."oska:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."oska:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."oska:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."oska:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'¤ ∫ التوحيد '..s1..'\n ¤ ∫ عدد الكتم  : '..s2)
end
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."oska:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_oskaa_new(oska1,oska2)
if oska2 and oska2.first_name_ then 
if oska2.first_name_:match("(.*)"..database:get(bot_id.."oska:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."oska:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local oska_nnn = database:get(bot_id.."oska:nump"..msg.chat_id_) or 5
local oska_nnn2 = database:get(bot_id.."oska:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(oska_nnn2) == tonumber(oska_nnn) or tonumber(oska_nnn2) > tonumber(oska_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."oska:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "¤ ∫ عزيزي >>["..oska2.username_.."](https://t.me/"..(oska2.username_ or "oska")..")\n¤ ∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."oska:teh"..msg.chat_id_).."} بجانب اسمك\n¤ ∫ عدد المحاولات المتبقيه {"..(tonumber(oska_nnn) - tonumber(oska_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_oskaa_new)
end
end
...
local oskaChengName = database:get(bot_id.."oska:Cheng:Name"..data.id_)
if not data.first_name_ then 
if oskaChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..oskaChengName..']')
database:del(bot_id.."oska:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if oskaChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."oska:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local oskaChengUserName = database:get(bot_id.."oska:Cheng:UserName"..data.id_)
if not data.username_ then 
if oskaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..oskaChengUserName..']')
database:del(bot_id.."oska:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if oskaChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."oska:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local oskaChengPhoto = database:get(bot_id.."oska:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if oskaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."oska:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if oskaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."oska:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
usertext = '\n¤ ∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'oska')..') '
...
{{text = 'ᴄʜ › ᴛʀᴏᴋs ᴛᴇᴀᴍ ⁦˖.',url="T.ME/uu12uu"}},
}
...
※︙ᴛʀᴏᴋs ᴛᴇᴀᴍ ⁦˖
------------- ᴇᴠ -------------
※︙[ᴄʜᴀɴɴᴇʟ ᴛʀᴏᴋs](T.ME/uu12uu)
※︙[ᴅᴇᴠʟᴘᴏᴇʀ](t.me/Sjr_20)
------------- ᴇᴠ -------------
※︙[ᴛᴡᴀsʟ sᴏᴜʀᴄᴇ](t.me/DE_HBOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevTROKSW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *※︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TROKS')..') \n*※︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *※︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TROKS')..') \n*※︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ 
if text == 'تحديث' and DevTROKSW(msg) then
dofile('TROKS.lua')  
send(msg.chat_id_, msg.id_, ' *※︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevTROKSW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTROKSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if TROKSSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevTROKSW(msg) then
...
if TROKSSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*※︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevTROKSW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTROKSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevTROKSW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevTROKSW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTROKSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevTROKSW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevTROKSW(msg) then
...
------------------------------------------------------------------------ 
if text == ("مسح المطورين") and DevTROKSW(msg) then
...
if text == 'الملفات' and DevTROKSW(msg) then
t = ' *※︙ملفات السورس تروكس ↓*\n*------------------------------------------------* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevTROKSW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TROKSTEAM/FIlES_TROKS/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *※︙اهلا بك في متجر ملفات تروكس*\n*※︙ملفات السورس ↓*\n*------------------------------------------------*\n\n"
local TextE = "\n*------------------------------------------------*\n *※︙علامة تعني { ✓ } ملف مفعل*\n *※︙علامة تعني { ✘ } ملف معطل*\n *※︙قناة سورس تروكس ↓*\n".." *※︙*[اضغط هنا لدخول](T.ME/uu12uu) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTROKSW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/TROKSTEAM/FIlES_TROKS/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('TROKS.lua')  
else
send(msg.chat_id_, msg.id_," *※︙عذرا الملف لايدعم سورس تروكس* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTROKSW(msg) then
...
if text == "مسح الملفات" and DevTROKSW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *※︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTROKSW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTROKSW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "TROKS")
...
function Function_TROKS(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TROKS, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TROKS, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *※︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TROKS')..')'
status  = '\n*※︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *※︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *※︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'TROKS')..')'
...
database:set(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *※︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TROKS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TROKS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *※︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TROKS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TROKS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TROKS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *※︙ارسل الكلمه الان*")  
database:set(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TROKS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TROKS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TROKS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TROKS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TROKS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TROKS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *※︙قائمة المنع* \n*-----------------------------------*\n"
for k,v in pairs(list) do  
local TROKS_Msg = database:get(bot_id.."TROKS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TROKS_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevTROKSW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *※︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevTROKSW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *※︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'TROKS')..')'..'\n*※︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevTROKSW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTROKSW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تروكس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تروكس')
local TROKS_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..TROKS_Msg[math.random(#TROKS_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTROKSW(msg) then 
...
if TROKSSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevTROKSW(msg) then 
...
if text == ("ردود المطور") and DevTROKSW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ※︙قائمة ردود المطور \n*-----------------------------------*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTROKSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevTROKSW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تروكس').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevTROKSW(msg) then   
...
if text == 'تعطيل المغادره' and DevTROKSW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TROKS')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
TROKSdx(msg.chat_id_, msg.id_, ' *※︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*※︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*※︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*※︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTROKSW(msg) then
...
*※︙م7 » لعرض اوامر التحشيش*
*※︙م8 » لعرض اوامر المطـورين*
*※︙م9 » لعرض اوامر المطـور الاساسي*
*※︙م10 » لعرض اوامر الاعضـاء*
ٴ----------------------------------------------
[ᴄʜ › ᴛʀᴏᴋs ᴛᴇᴀᴍ ⁦˖](T.ME/uu12uu)
...
send(msg.chat_id_, msg.id_, t..'ٴ※︙-------------- ᴇᴠ --------------︙※\n※︙اضغط على الاسم ليتم نسخه')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تروكس')
...
TROKS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TROKS)
...
--------------------------------------------------------------------------------------------------------------
SourceTROKS(data.message_,data)
...
------------------------------------------------------------------------
local TROKSAbot = database:get(bot_id.."TROKS1:Add:Filter:Rp2"..text..result.chat_id_)   
if TROKSAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *※︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n※︙["..TROKSAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TROKS1_Msg = database:get(bot_id.."TROKS1:Add:Filter:Rp2"..text..result.chat_id_)   
if TROKS1_Msg then
send(msg.chat_id_, msg.id_," ※︙"..TROKS1_Msg)
